...
RUN wget https://developer.download.nvidia.com/compute/cuda/repos/ubuntu2404/x86_64/cuda-keyring_1.1-1_all.deb \
    ...
    && apt-get update \
    && apt-get install -y cuda-toolkit-13-0 libcudnn9-cuda-13 libnvinfer-plugin10 libnvinfer-headers-plugin-dev libnvinfer10 libnvinfer-headers-dev libnvinfer-lean10 libnvinfer-dispatch10 \
    && rm -rf /var/lib/apt/lists/*
